...
C {devices/vsource.sym} 80 -10 0 0 {name=V2 value="pulse 0 1.8 0 1p 1p 10n 20n"  
		}
...
C {devices/gnd.sym} 180 -40 0 0 {name=l12 lab=GND}
C {devices/lab_pin.sym} 70 160 0 0 {name=l13 sig_type=std_logic lab=CIN}
