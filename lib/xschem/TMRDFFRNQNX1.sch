...
C {devices/ipin.sym} -160 20 0 0 {name=p4 lab=RN}
...
C {devices/lab_pin.sym} -70 -40 0 0 {name=l7 sig_type=std_logic lab=RN}
C {devices/lab_pin.sym} -70 90 0 0 {name=l8 sig_type=std_logic lab=RN}
C {devices/lab_pin.sym} -70 220 0 0 {name=l9 sig_type=std_logic lab=RN}
