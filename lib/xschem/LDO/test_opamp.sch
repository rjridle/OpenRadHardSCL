...
device=resistor
m=1}
C {devices/vsource.sym} -90 -140 0 0 {name=V1 value=0.7 net_name=true}
...
current=2.8692e-04}
C {LDO/opamp_2stage_V2.sym} 50 0 2 1 {name=x1 VDD=VDD GND=GND}
C {devices/spice_probe.sym} 60 0 0 0 {name=p1 attrs=""
voltage=0.789}
C {devices/spice_probe.sym} -100 100 0 1 {name=p2 attrs=""
voltage=0.5738}
